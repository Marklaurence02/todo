...
if(isset($_POST['submit'])) {
    ...
    if($update_result) {
        ...
        echo "<span class='success-message'>Task updated successfully.</span>";
        echo "<span style='font-size:100px;'>&#128516;</span>";
        exit();
    } else {
        // Error updating task
        echo "Error updating task: " . mysqli_error($db);
        echo "<span style='font-size:100px;'>&#128542;</span>" . mysqli_error($db);
        exit();
    }
}
...
if(isset($_POST['delete_file'])) {
    ...
    if($update_file_result) {
        ...
        echo "<span  class='success-message'>File data deleted successfully.
        <span style='font-size:100px;'>&#128516;</span></span>";
     
    } else {
        // Error updating file data in the database
        echo "<span class='error-message'> Error updating file data in the database:
        <span style='font-size:100px;'>&#128542;</span></span> " . mysqli_error($db);
    }
}
